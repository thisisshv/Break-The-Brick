...
public class Gameplay extends JPanel implements KeyListener, ActionListener {
    // So that the game doesn't start by itself
    private boolean play = false;
    // So that the score is 0 by default
    private int score = 0;
    ...
    public void actionPerformed(ActionEvent e) {
        timer.start();
        if (play) {
            // Took Rectangle here because insection between a rectangle ball and a
            // rectangle player will be done.
